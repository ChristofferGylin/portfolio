...
export const clickScreenshot = (path) => {
    ...
    const closeIcon = `<div class="popup-close-container" id="closeIconSvgScreenshot"><div class="popup-close-icon-screenshot"><svg class="close-icon-svg" id="closeIconScreenshotSvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 90">
